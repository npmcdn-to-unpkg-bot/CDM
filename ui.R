...
fluipage.Yield_evo =fluidPage(
                      ...
                      fluidRow(
                        box(width = 12,title = 'Data table',
                            dataTableOutput('evo_plot_dtable'))
                      )
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem('Cargo IS', icon = icon('database'),
               ...
               menuSubItem('Top airports/air routes', tabName = 'cargois_top', icon = icon('hand-o-up')),
               menuSubItem('Treemap', tabName = 'cargois_treemap', icon = icon('bars')),
               menuSubItem('Yield evolution', tabName = 'cargois_plot', icon = icon('line-chart')),
